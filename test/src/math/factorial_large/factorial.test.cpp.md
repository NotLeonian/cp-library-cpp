...
data:
  ...
  bundledCode: "#line 1 \"test/src/math/factorial_large/factorial.test.cpp\"\n#define\
    ...
    \ : _large_fac(n).inv();\n        }\n        static value_type binom(long long\
    \ n, long long r) {\n            if (n < 0 or r < 0 or n < r) return 0;\n    \
    \        return _binom_lucas(n, r);\n        }\n        // binom(n, r) \u306E\u9006\
    \u6570\n        // binom(n, r) = 0 \u306E\u5834\u5408\u306F assert \u9055\u53CD\
    \u3068\u306A\u308B\n        static value_type binom_inv(long long n, long long\
    \ r) {\n            assert(r >= 0 and n >= r);\n            return _binom_inv_lucas(n,\
    \ r);\n        }\n        // n \u7A2E\u985E\u304B\u3089\u91CD\u8907\u3092\u8A31\
    \u3057\u3066 r \u500B\u9078\u3076\u5834\u5408\u306E\u6570\n        // x_1+x_2+...+x_n=r\uFF08\
    x_i \u306F\u975E\u8CA0\u6574\u6570\uFF09\u3068\u306A\u308B x \u306E\u500B\u6570\
    \u3067\u3082\u3042\u308B\n        // multichoose(n, r) = binom(n + r - 1, r)\n\
    ...
    \ - 1, r);\n        }\n        // n \u7A2E\u985E\u304B\u3089\u91CD\u8907\u3092\
    \u8A31\u3057\u3066 r \u500B\u9078\u3076\u5834\u5408\u306E\u6570 multichoose(n,\
    \ r) \u306E\u9006\u6570\n        // x_1+x_2+...+x_n=r\uFF08x_i \u306F\u975E\u8CA0\
    \u6574\u6570\uFF09\u3068\u306A\u308B x \u306E\u500B\u6570\u306E\u9006\u6570\u3067\
    \u3082\u3042\u308B\n        // multichoose(n, r) = binom(n + r - 1, r)\n     \
    \   // multichoose(n, r) = 0 \u306E\u5834\u5408\u306F assert \u9055\u53CD\u3068\
    \u306A\u308B\n        static value_type multichoose_inv(long long n, long long\
    \ r) {\n            assert(n >= 0 and r >= 0);\n            if (r == 0) return\
    \ value_type(1);\n            assert(n > 0);\n            return binom_inv(n +\
    ...
    \              n /= p;\n                r /= p;\n            }\n            return\
    \ res;\n        }\n        static value_type _binom_inv_lucas(long long n, long\
    \ long r) {\n            assert(0 <= r and r <= n);\n\n            value_type\
    \ res = 1;\n            const int p = value_type::mod();\n\n            while\
    \ (n or r) {\n                const int ni = n % p;\n                const int\
    \ ri = r % p;\n\n                assert(ri <= ni);\n                res *= _binom_inv_under_mod(ni,\
    \ ri);\n\n                n /= p;\n                r /= p;\n            }\n  \
    \          return res;\n        }\n\n        static inline std::vector<value_type>\
    \ _block_fac{};\n\n        static void _build() {\n            if (_block_fac.size())\
